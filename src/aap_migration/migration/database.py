...
from aap_migration.utils.logging import get_logger, sanitize_database_url
...
def reset_database(database_url: str) -> None:
    ...
    try:
        ...
        logger.warning(
            "All database tables dropped", database_url=sanitize_database_url(database_url)
        )

        # Recreate all tables
        Base.metadata.create_all(engine)
        logger.info("Database tables recreated", database_url=sanitize_database_url(database_url))

...
help: ## Show this help message
	...
	@echo "    make build && make up-dev          # Build and start bridge + postgres"
	@echo "    make shell                         # Shell into bridge container"
	@echo "    make c-check                       # Run checks inside bridge container"
	@echo ""
	@echo "  Web UI workflow (optional):"
	@echo "    make build-all && make up          # Build and start db + engine + ui"
	@echo "    make shell-engine                  # Shell into engine container"

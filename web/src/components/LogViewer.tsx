...
export function LogViewer({ jobId, onClose, fullPage }: Props) {
  ...
  return (
    <div className="log-viewer">
      <div className="log-viewer__toolbar">
        ...
        <div className="log-viewer__toolbar-group">
          <Tooltip content="Scroll to top">
            <Button variant="plain" size="sm" onClick={scrollToTop} aria-label="Scroll to top">
              <AngleDoubleUpIcon />
            </Button>
          </Tooltip>
          <Tooltip content="Scroll to bottom">
            <Button variant="plain" size="sm" onClick={scrollToBottom} aria-label="Scroll to bottom">
              <AngleDoubleDownIcon />
            </Button>
          </Tooltip>
          {isRunning && (
      ...
      <div
        ref={scrollRef}
        className={`log-viewer__content${fullPage ? ' log-viewer__content--fullpage' : ''}`}
              ...
              return (
                <div key={index}>
                  <div
                    ...
                    onClick={isHeader ? () => toggleCollapse(index) : undefined}
                  >
                    ...
                    <div className="log-viewer__line-content">
                      <Ansi input={line} />
                    </div>
                  </div>
                  {isHeader && isCollapsed && (
                    <div
                      className="log-viewer__ellipsis"
